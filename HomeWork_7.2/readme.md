...
### Ответ
*  Выполнено, 
*  Мы в файле 'variables.tf' указывае нужные нам переменные с токенами и id, и там же им присваиваем значения. 
*  Пример файла [тут](https://github.com/Artegro/netology/blob/main/HomeWork_7.2/terrraform/variables.tf).
---------
