...
### Ответ
*  Выполнено, в файлах тераформа , прикрепленных к репозитарию [тут](https://github.com/Artegro/netology/blob/main/HomeWork_7.2/terrraform/variables.tf) вроде всё сделано.
---------
